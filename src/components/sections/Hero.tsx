      ...
      <Container className="flex flex-col lg:flex-row gap-10 lg:gap-12">
        ...
        >
          <h1 className="text-heading-1 text-3xl sm:text-4xl md:text-5xl xl:text-6xl font-bold">
            Brighten Your Celebrations with
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-violet-600 ml-2">
              Stunning Lighting{" "}
            </span>
          </h1>
          <Paragraph className="mt-8">
            Discover a world of decorative lighting that adds sparkle to your festivals,
            events, and everyday moments. Our curated collection features energy-saving,
            weather-resistant, and visually captivating lights perfect for homes, businesses,
            and venues. Whether you’re celebrating Diwali, Christmas, or a grand wedding,
            we have the perfect lighting solutions to create unforgettable experiences.

            Where creativity meets illumination — let your spaces shine!
          </Paragraph>
